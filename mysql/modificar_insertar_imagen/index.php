...
if ($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(isset($_FILES['file'])){
        $imagenPath="img/".$_FILES['file']['name'];
        if(move_uploaded_file($_FILES['file']['tmp_name'],$imagenPath)){
            $imagen=$imagenPath;
        }
        else{
            $mensaje = "ERROR: No se ha subido la noticia con una imagen personalizada <a href='modificar.php'>Volver a la página principal</a>";
            echo $mensaje;
        }
    }
   // echo "<img src='$imagen' alt='SUBE TU IMAGEN' width='100'>";
...
// Bucle sobre los resultados obtenidos. 
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <form name="form" action="eliminar.php" method="POST" enctype="multipart/form-data">
                    <br>
        ...
        <tr>
            ...
            <td colspan="6" style="padding:30px">
                ...
                <form name="form" action="index.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" list="categorias" name="categoria" value=""><br>
                    <datalist name="categorias">
                    </datalist>
                    Subir Imagen:<br>

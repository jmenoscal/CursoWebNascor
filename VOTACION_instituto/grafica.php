...
<h2><p align="center"><font color="red" face="Times New Roman"> GRÁFICA DE LA ENCUESTA </font></p></h2>

<body>
<font color="orange" size="3" face="Times New Roman"><br><h3>Crees que el barça ganará la liga</h3></font>
...
echo "<br><br>";
echo "SI: <b>$total1</b> votos - <b>$por1 %</b> ";   // OPCION 1 CON NUMERO DE VOTOS Y PORCENTAJE
echo "<IMG HEIGHT=15 WIDTH=$por1 SRC=blue.png>";  // MUESTRA OPCION 1 CON BARRA DE IMAGEN
echo "<br>";
echo "<br><br>";

echo "NO: <b>$total2</b> votos - <b>$por2 %</b> ";   // OPCION 2 CON NUMERO DE VOTOS Y PORCENTAJE
